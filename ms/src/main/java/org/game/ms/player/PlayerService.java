...
public class PlayerService {
    ...
    private void skillInit(Player player) {
        ...
        player.setCounterAttack(skillService.physicalAttack());
        player.getCounterAttack().setSkillType(SkillType.COUNTER_ATTACK);
...
//        player.getSkills().add(skillService.getSkillById(1110020203000000L));
        player.getSkills().add(skillService.getSkillById(1110020205000000L));
